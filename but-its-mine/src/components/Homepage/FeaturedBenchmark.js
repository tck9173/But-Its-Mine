...
function FeaturedBenchmark() {
    return (
        <div className='featured'>
            ...
            <iframe title='Featured Benchmark' width="874" height="500" src="https://www.youtube.com/embed/uEXv8A0-_KU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
