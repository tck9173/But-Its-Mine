...
function FeaturedNews() {
    return (
        <div className='featured'>
            ...
            <iframe title='Featured News' width="874" height="500" src="https://www.youtube.com/embed/JDN8rLjWrTQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
